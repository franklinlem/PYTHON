...
print('%s tem %d substrings \'ss\' até a posição 10' % (palavra, palavra.count('ss', 0, 10)))
print('Usando o método da classe string: ')
print('%s tem %d substrings \'ss\'' % (palavra, str.count(palavra, 'ss')))
print('%s tem %d substrings \'ss\' até a posição 10' % (palavra, str.count(palavra,'ss', 0, 10)))